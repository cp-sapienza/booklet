\section{Maths}
\todo{Game Theory, Grundy Theorem, permutation to/from index}
...
Count the number of rotationally distinct colouring of a cube using $n$ different colours.
