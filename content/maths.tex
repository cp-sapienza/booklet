...
Returns ${x^{-1}}$\:\%\:mod. For prime moduli, the answer always exists. For non prime moduli, returns $-1$ if no answer exists, i.e. if $gcd(n,mod) \neq 1$.
...
Some examples of problems solved by Catalan Numbers are:
\begin{itemize}
