...
\snippet{source/segment-sparse.cpp}
...
\snippet{source/segment_lower_bound.cpp}


\subsection{Union find}
\snippet{source/ufds.cpp}

\subsection{Sparse table}
\bigo{NlogN} construction and memory usage, \bigo{1} query.
\snippet{source/sparse-table.cpp}
...
\snippet{source/line_container.cpp}
...
\end{lstlisting}
\snippet{source/treap.cpp}


\subsection{Link Cut Tree}
\bigo{\log N} per operation
\snippet{source/link_cut_tree.cpp}
